...
{
    public partial class EldenFormConvergence : Form
    {
        [Localize]
        ...
        public EldenFormConvergence(bool dumpMessages = false, bool loadEmpty = false)
        {
            InitializeComponent();
            Text = $"Elden Ring Convergence Item Randomizer {Randomizer.EldenVersion}";
